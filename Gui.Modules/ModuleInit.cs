...
using SKnoxConsulting.SafeAndSound.Gui.Modules.Views;

namespace SKnoxConsulting.SafeAndSound.Gui.Modules
{
    public class ModuleInit : IModule
    {
        ...
        public void Initialize()
        {
           ...
           // this._mainRegionController = this.container.Resolve<MainRegionController>();
            ...
            //this.regionManager.RegisterViewWithRegion( RegionNames.MainRegion,  () => this.container.Resolve<BackupSetView>());
