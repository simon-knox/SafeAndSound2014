...
//            try
//            {
//                SubDirectories = new ObservableCollection<DirectoryViewModel2>(di.GetDirectories("*", SearchOption.TopDirectoryOnly)
//                    .Select(d => new DirectoryViewModel2(d.FullName)));
//            }
